...
const {postById, getPosts, createPost, postsByUser, isPoster,updatePost, deletePost, postPhoto} = require("../controllers/postController");
...
// Photo
router.get("/user/photo/:postId", postPhoto);
